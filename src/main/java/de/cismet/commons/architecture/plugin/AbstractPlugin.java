...
//    }
    ...
    public AbstractPlugin(final PluginContext context) {
        ...
        try {
            ...
            // ToDo give context to broker --> finer initalization messages map component initialized search
            // components etc
            configurePlugin();
...
// TODO add your handling code here:
    ...
    private void openUrlInExternalBrowser(final String url) {
        try {
            ...
            log.warn(java.util.ResourceBundle.getBundle("de/cismet/cismap/commons/GuiBundle").getString(
                    "FeatureInfoDisplay.log.Fehler_beim_Oeffnen_von") + url
                        + java.util.ResourceBundle.getBundle("de/cismet/cismap/commons/GuiBundle").getString(
                            "FeatureInfoDisplay.log.Neuer_Versuch"),
                e);
            ...
            try {
                ...
                log.warn(java.util.ResourceBundle.getBundle("de/cismet/cismap/commons/GuiBundle").getString(
                        "FeatureInfoDisplay.log.Auch_das_2te_Mal_ging_schief.Fehler_beim_Oeffnen_von") + url
                            + java.util.ResourceBundle.getBundle("de/cismet/cismap/commons/GuiBundle").getString(
                                "FeatureInfoDisplay.log.Letzter_Versuch"),
                    e2);
                try {
                    de.cismet.tools.BrowserLauncher.openURL("file://" + url);
                } catch (Exception e3) {
                    log.error(java.util.ResourceBundle.getBundle("de/cismet/cismap/commons/GuiBundle").getString(
                            "FeatureInfoDisplay.log.Auch_das_3te_Mal_ging_schief.Fehler_beim_Oeffnen_von:file://")
                                + url,
                        e3);
                }
            }
...
//                            log.debug("Beende ohne Änderungen zu speichern");
//                        }
                        // JOptionPane.Inf(this, "Es traten Fehler beim abspeichern des Flurstuecks auf", "Fehler",
